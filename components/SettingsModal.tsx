            ...
            >
                ...
                <div className="space-y-6">
                    ...
                    <div className="border-t border-brand-surface pt-6">
                        ...
                        <p className="text-sm text-brand-text-secondary mb-4">
                            Danksagungen und Attributionen für verwendete Ressourcen.
                        </p>

                        {!showCredits ? (
                            <button
                                onClick={() => setShowCredits(true)}
                                className="bg-white text-black font-semibold px-5 py-2 rounded-full hover:bg-gray-200 transition-colors flex items-center gap-2 w-fit"
                            >
                                <span className="material-symbols-outlined" style={{ fontSize: '20px' }}>info</span>
                                Credits anzeigen
                            </button>
                        ) : (
                            <div className="bg-brand-surface rounded-xl p-4 space-y-3 animate-fade-in">
                                <div className="flex justify-between items-start">
                                    <h4 className="font-semibold text-white">Verwendete Ressourcen</h4>
                                    <button
                                ...
                                <ul className="space-y-2 text-sm text-brand-text-secondary">
                                    <li className="flex items-center gap-2">
                                        <span className="material-symbols-outlined text-brand-primary" style={{ fontSize: '16px' }}>image</span>
                                        <span>Favicon/PWA Icon: <a href="https://www.flaticon.com/free-icons/budget" target="_blank" rel="noopener noreferrer" className="text-brand-primary hover:underline">Budget icons created by Freepik - Flaticon</a></span>
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <span className="material-symbols-outlined text-brand-primary" style={{ fontSize: '16px' }}>text_fields</span>
                                        <span>Globale Schriftart: Ubuntu</span>
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <span className="material-symbols-outlined text-brand-primary" style={{ fontSize: '16px' }}>font_download</span>
                                        <span>Sonstige Symbole: Google Fonts Icon</span>
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <span className="material-symbols-outlined text-brand-primary" style={{ fontSize: '16px' }}>code</span>
                                        <span>Gesamte Webseite Erstellung: Vibe Coding mit Gemini AI</span>
                                    </li>
                                </ul>
                            </div>
                        )}
